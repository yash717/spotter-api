...
class InvitationAcceptSerializer(serializers.Serializer):
    ...
    cycle_used_hours = serializers.DecimalField(
        max_digits=5, decimal_places=1, required=False, default=0,
    ...
    odometer = serializers.DecimalField(
        max_digits=10, decimal_places=1, required=False, default=0
    )
...
class InvitationListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "sent_at", "accepted_at", "personal_message",
            "resend_count", "last_resent_at", "invited_by_email",
        ]
...
class InvitationDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "invited_by_email", "accepted_by_email",
        ]
        read_only_fields = fields
